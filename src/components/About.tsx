...
const About = () => {
  return (
    <section id="about" className="min-h-[100svh] flex items-center bg-red-950">
      <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="w-16 sm:w-24 h-0.5 bg-red-500 mb-8"></div>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-red-900 to-red-950 flex items-center justify-center">
              <div className="text-gray-400 text-center">
                <div className="w-24 h-24 mx-auto mb-4 bg-red-800 rounded-full flex items-center justify-center">
